...
var routes = [
  ...
  {
    path: "dashboard",
    loadComponent: () => import("./chunk-MACEJYXL.js").then((m) => m.DashboardComponent)
  },
  {
    path: "rooms",
    loadComponent: () => import("./chunk-DQKVI5OJ.js").then((m) => m.RoomsComponent)
  },
  {
    path: "bookings",
    loadComponent: () => import("./chunk-2CVBIEPT.js").then((m) => m.BookingsComponent)
  },
  {
    path: "housekeeping",
    loadComponent: () => import("./chunk-AXHF5EP3.js").then((m) => m.HousekeepingComponent)
  },
  {
    path: "room-service",
    loadComponent: () => import("./chunk-XK6VDMZW.js").then((m) => m.RoomServiceComponent)
  },
  {
    path: "maintenance",
    loadComponent: () => import("./chunk-REVRQOPY.js").then((m) => m.MaintenanceComponent)
  },
...
function AppComponent_For_12_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275classMapInterpolate1("bi ", item_r1.icon, "");
    \u0275\u0275advance(2);
...
var AppComponent = class _AppComponent {
  constructor() {
    ...
    this.connectionIcon = computed(() => {
      ...
      if (s === "connected")
        return { icon: "bi-circle-fill", cls: "text-success", label: "Real-Time Ulandi" };
      if (s === "connecting")
        return { icon: "bi-arrow-repeat", cls: "text-warning", label: "Ulanmoqda..." };
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AppComponent, selectors: [["app-root"]], decls: 20, vars: 7, consts: [[1, "app-layout"], [1, "sidebar"], [1, "sidebar-brand"], [1, "brand-icon"], [1, "brand-name"], [1, "brand-sub"], [1, "sidebar-nav"], ["routerLinkActive", "active", 1, "nav-item", 3, "routerLink"], [1, "sidebar-footer"], [1, "connection-badge"], [1, "main-content"]], template: function AppComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275repeaterCreate(11, AppComponent_For_12_Template, 4, 5, "a", 7, _forTrack0);
        \u0275\u0275elementEnd();
      ...
      if (rf & 2) {
        ...
        \u0275\u0275advance(3);
        \u0275\u0275classMap(ctx.signalR.connectionState());
        \u0275\u0275advance();
        \u0275\u0275classMapInterpolate2("bi ", ctx.connectionIcon().icon, " ", ctx.connectionIcon().cls, "");
        \u0275\u0275advance(2);
        \u0275\u0275textInterpolate(ctx.connectionIcon().label);
      }
    }, dependencies: [RouterOutlet, RouterLink, RouterLinkActive, CommonModule], styles: ['@charset "UTF-8";\n\n\n\n.app-layout[_ngcontent-%COMP%] {\n  display: flex;\n  min-height: 100vh;\n}\n.sidebar[_ngcontent-%COMP%] {\n  width: 220px;\n  min-height: 100vh;\n  background: var(--bg-secondary);\n  border-right: 1px solid var(--border);\n  display: flex;\n  flex-direction: column;\n  position: fixed;\n  left: 0;\n  top: 0;\n  bottom: 0;\n  z-index: 100;\n}\n.sidebar-brand[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  gap: 12px;\n  padding: 24px 20px;\n  border-bottom: 1px solid var(--border);\n}\n.brand-icon[_ngcontent-%COMP%] {\n  font-size: 28px;\n  line-height: 1;\n}\n.brand-name[_ngcontent-%COMP%] {\n  font-size: 15px;\n  font-weight: 700;\n  color: var(--text-primary);\n}\n.brand-sub[_ngcontent-%COMP%] {\n  font-size: 11px;\n  color: var(--text-muted);\n  margin-top: 1px;\n}\n.sidebar-nav[_ngcontent-%COMP%] {\n  flex: 1;\n  padding: 16px 12px;\n  display: flex;\n  flex-direction: column;\n  gap: 2px;\n}\n.nav-item[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  gap: 10px;\n  padding: 10px 12px;\n  border-radius: var(--radius-sm);\n  color: var(--text-secondary);\n  text-decoration: none;\n  font-size: 13px;\n  font-weight: 500;\n  transition: var(--transition);\n}\n.nav-item[_ngcontent-%COMP%]   i[_ngcontent-%COMP%] {\n  font-size: 16px;\n  width: 20px;\n  text-align: center;\n}\n.nav-item[_ngcontent-%COMP%]:hover {\n  background: var(--bg-hover);\n  color: var(--text-primary);\n}\n.nav-item.active[_ngcontent-%COMP%] {\n  background: var(--accent-glow);\n  color: var(--accent);\n  border-left: 2px solid var(--accent);\n}\n.sidebar-footer[_ngcontent-%COMP%] {\n  padding: 16px;\n  border-top: 1px solid var(--border);\n}\n.connection-badge[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  gap: 8px;\n  font-size: 11px;\n  color: var(--text-muted);\n  padding: 8px 10px;\n  border-radius: var(--radius-sm);\n  background: var(--bg-card);\n  border: 1px solid var(--border);\n}\n.connection-badge[_ngcontent-%COMP%]   i[_ngcontent-%COMP%] {\n  font-size: 8px;\n}\n.main-content[_ngcontent-%COMP%] {\n  flex: 1;\n  margin-left: 220px;\n  padding: 28px;\n  min-height: 100vh;\n  background: var(--bg-primary);\n}\n@media (max-width: 768px) {\n  .sidebar[_ngcontent-%COMP%] {\n    width: 60px;\n  }\n  .sidebar-brand[_ngcontent-%COMP%]   .brand-name[_ngcontent-%COMP%], \n   .sidebar-brand[_ngcontent-%COMP%]   .brand-sub[_ngcontent-%COMP%], \n   .nav-item[_ngcontent-%COMP%]   span[_ngcontent-%COMP%], \n   .connection-badge[_ngcontent-%COMP%]   span[_ngcontent-%COMP%] {\n    display: none;\n  }\n  .sidebar-brand[_ngcontent-%COMP%] {\n    justify-content: center;\n    padding: 20px 10px;\n  }\n  .nav-item[_ngcontent-%COMP%] {\n    justify-content: center;\n    padding: 12px;\n  }\n  .main-content[_ngcontent-%COMP%] {\n    margin-left: 60px;\n    padding: 16px;\n  }\n}\n/*# sourceMappingURL=app.component.css.map */'] });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AppComponent, [{
    type: Component,
    args: [{ selector: "app-root", standalone: true, imports: [RouterOutlet, RouterLink, RouterLinkActive, CommonModule], template: '<div class="app-layout">\n\n  <!-- \u2550\u2550 SIDEBAR \u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550 -->\n  <aside class="sidebar">\n    <div class="sidebar-brand">\n      <div class="brand-icon">\u{1F3E8}</div>\n      <div>\n        <div class="brand-name">GrandStay</div>\n        <div class="brand-sub">HotelOS v2</div>\n      </div>\n    </div>\n\n    <nav class="sidebar-nav">\n      @for (item of navItems; track item.path) {\n        <a [routerLink]="item.path" routerLinkActive="active" class="nav-item">\n          <i class="bi {{ item.icon }}"></i>\n          <span>{{ item.label }}</span>\n        </a>\n      }\n    </nav>\n\n    <div class="sidebar-footer">\n      <div class="connection-badge" [class]="signalR.connectionState()">\n        <i class="bi {{ connectionIcon().icon }} {{ connectionIcon().cls }}"></i>\n        <span>{{ connectionIcon().label }}</span>\n      </div>\n    </div>\n  </aside>\n\n  <!-- \u2550\u2550 MAIN CONTENT \u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550 -->\n  <main class="main-content">\n    <router-outlet></router-outlet>\n  </main>\n\n</div>\n', styles: ['@charset "UTF-8";\n\n/* src/app/app.component.scss */\n.app-layout {\n  display: flex;\n  min-height: 100vh;\n}\n.sidebar {\n  width: 220px;\n  min-height: 100vh;\n  background: var(--bg-secondary);\n  border-right: 1px solid var(--border);\n  display: flex;\n  flex-direction: column;\n  position: fixed;\n  left: 0;\n  top: 0;\n  bottom: 0;\n  z-index: 100;\n}\n.sidebar-brand {\n  display: flex;\n  align-items: center;\n  gap: 12px;\n  padding: 24px 20px;\n  border-bottom: 1px solid var(--border);\n}\n.brand-icon {\n  font-size: 28px;\n  line-height: 1;\n}\n.brand-name {\n  font-size: 15px;\n  font-weight: 700;\n  color: var(--text-primary);\n}\n.brand-sub {\n  font-size: 11px;\n  color: var(--text-muted);\n  margin-top: 1px;\n}\n.sidebar-nav {\n  flex: 1;\n  padding: 16px 12px;\n  display: flex;\n  flex-direction: column;\n  gap: 2px;\n}\n.nav-item {\n  display: flex;\n  align-items: center;\n  gap: 10px;\n  padding: 10px 12px;\n  border-radius: var(--radius-sm);\n  color: var(--text-secondary);\n  text-decoration: none;\n  font-size: 13px;\n  font-weight: 500;\n  transition: var(--transition);\n}\n.nav-item i {\n  font-size: 16px;\n  width: 20px;\n  text-align: center;\n}\n.nav-item:hover {\n  background: var(--bg-hover);\n  color: var(--text-primary);\n}\n.nav-item.active {\n  background: var(--accent-glow);\n  color: var(--accent);\n  border-left: 2px solid var(--accent);\n}\n.sidebar-footer {\n  padding: 16px;\n  border-top: 1px solid var(--border);\n}\n.connection-badge {\n  display: flex;\n  align-items: center;\n  gap: 8px;\n  font-size: 11px;\n  color: var(--text-muted);\n  padding: 8px 10px;\n  border-radius: var(--radius-sm);\n  background: var(--bg-card);\n  border: 1px solid var(--border);\n}\n.connection-badge i {\n  font-size: 8px;\n}\n.main-content {\n  flex: 1;\n  margin-left: 220px;\n  padding: 28px;\n  min-height: 100vh;\n  background: var(--bg-primary);\n}\n@media (max-width: 768px) {\n  .sidebar {\n    width: 60px;\n  }\n  .sidebar-brand .brand-name,\n  .sidebar-brand .brand-sub,\n  .nav-item span,\n  .connection-badge span {\n    display: none;\n  }\n  .sidebar-brand {\n    justify-content: center;\n    padding: 20px 10px;\n  }\n  .nav-item {\n    justify-content: center;\n    padding: 12px;\n  }\n  .main-content {\n    margin-left: 60px;\n    padding: 16px;\n  }\n}\n/*# sourceMappingURL=app.component.css.map */\n'] }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AppComponent, { className: "AppComponent", filePath: "app/app.component.ts", lineNumber: 13 });
})();
