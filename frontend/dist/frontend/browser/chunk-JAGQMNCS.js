...
var VERSION2 = new Version("19.2.22");
...
var SignalRService = class _SignalRService {
  constructor() {
    ...
    this.latestEvent = signal(null);
    this.latestRoom = signal(null);
    this.latestStats = signal(null);
    this.hub = new HubConnectionBuilder().withUrl("http://localhost:5000/hotelHub", {
      skipNegotiation: false,
      transport: HttpTransportType.WebSockets
    }).withAutomaticReconnect([1e3, 2e3, 5e3, 1e4]).configureLogging(LogLevel.Warning).build();
...
@angular/router/fesm2022/router.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-JAGQMNCS.js.map
